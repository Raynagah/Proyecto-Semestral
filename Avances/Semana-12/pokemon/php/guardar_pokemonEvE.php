...
$rol     = 'jugador'; // Siempre será jugador para esta página
...
$sql = "
  ...
  ON DUPLICATE KEY UPDATE
    ...
    rol     = 'jugador'  -- Asignar rol de jugador directamente
";
$stmt = $conn->prepare($sql);
$stmt->bind_param("isisssss", $id, $nombre, $pokedex, $mov1, $mov2, $mov3, $mov4, $rol);
